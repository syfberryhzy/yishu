    ...
    <div class="page section2 section" id="page-2">
        <div class="container viewpointdetail-page2-content">
            <div class="viewpointdetail-page2-content-nav">
                <div class="viewpointdetail-page2-content-nav-viewpoint pull-left">观点咨询</div>
                <button type="button" class="btn btn-default pull-right viewpointdetail-page2-content-nav-button" onclick="history.go(-1)">返回</button>
            </div>
            <div class="viewpointdetail-page2-content-section">
                <div class="viewpointdetail-page2-content-section-title">
                    2017你应该知道的数字营销策略
                </div>
                <div class="viewpointdetail-page2-content-section-date">2017-03-10 18:17</div>
                ...
                <div class="viewpointdetail-page2-content-section-text">电影首页：显示“影院热映”，“即将上映”以及“精选榜单”，测试之后发现精选榜单只有Top250的 API
                    接口能正常使用，于是，豆瓣Top250、口碑榜、新片榜、票房榜使用同一个 API 接口，只是请求的数据参数不一样。由于微信小程序的 request 的最
                </div>
                <div class="viewpointdetail-page2-content-section-text">大并发数是 5，所以用户进入程序时只加载“影院热映”、“即将上映”的数据，界面滑动之后再加载榜单数据。</div>
                <div class="viewpointdetail-page2-content-section-text">
